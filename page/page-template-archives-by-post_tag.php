<?php
/**
 * Template Name: Archives By Post Tag
 *
 * @package Unique
 * @subpackage Template
 * @since 0.1.0
						...
						<div class="entry-content">
							...
							foreach ( $terms as $term ) {
								...
								$loop = new WP_Query(
									array(
										'tax_query' => array(
											array( 'taxonomy' => 'post_tag', 'field' => 'slug', 'terms' => array( $term->slug ) )
										)
									)
								); ?>
								...
								<?php if ( $loop->have_posts() ) : ?>
									...
									<?php while ( $loop->have_posts() ) : $loop->the_post(); ?>
										<li><?php the_title( '<a href="' . get_permalink() . '" title="' . the_title_attribute( 'echo=0' ) . '">', '</a>' ); ?> <span class="comments-number">(<?php comments_number( '0', '1', '%' ); ?>)</span></li>
									<?php endwhile; ?>
									</ul>
