<?php
/**
 * Template Name: Most Viewed Pages
 *
						...
						<div class="entry-content">
							...
							<?php if ( $loop->have_posts() ) : ?>
								...
								<?php while ( $loop->have_posts() ) : $loop->the_post(); ?>
									<li><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a> <span class="views-number">(<?php echo entry_views_get(); ?>)</span></li>
								<?php endwhile; ?>
								</ul>
